...
import com.rsh.st.trident_drpc.function.CSVSplit;
import com.rsh.st.trident_drpc.function.FormatCall;
...
public class LogAnalyserTrident {
  public static void main(String[] args) throws Exception {
    ...
    FeederBatchSpout testSpout =
        new FeederBatchSpout(ImmutableList.of("fromMobileNumber", "toMobileNumber", "duration"));
